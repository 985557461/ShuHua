    ...
    public boolean handleMessage(Message message) {
        switch(message.what) {
            case MSG_USERID_FOUND: {
                Toast.makeText(this, "ÓÃ»§ÐÅÏ¢ÒÑ´æÔÚ£¬ÕýÔÚÌø×ªµÇÂ¼²Ù×÷", Toast.LENGTH_SHORT).show();
            }
            break;
            case MSG_LOGIN: {
...
//				builder.create().show();
            ...
            case MSG_AUTH_CANCEL: {
                Toast.makeText(this, "ÊÚÈ¨È¡Ïû", Toast.LENGTH_SHORT).show();
                System.out.println("-------MSG_AUTH_CANCEL--------");
            }
            break;
            case MSG_AUTH_ERROR: {
                Toast.makeText(this, "ÊÚÈ¨Ê§°Ü", Toast.LENGTH_SHORT).show();
                System.out.println("-------MSG_AUTH_ERROR--------");
            }
            break;
            case MSG_AUTH_COMPLETE: {
                Toast.makeText(this, "ÊÚÈ¨³É¹¦", Toast.LENGTH_SHORT).show();
