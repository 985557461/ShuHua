...
import com.xy.shuhua.ui.gpuimage.util.GPUImageFilterTools;
import com.xy.shuhua.ui.quadrilateral_crop.QuadrilateralCropImageView;
import com.xy.shuhua.util.DialogUtil;
import com.xy.shuhua.util.FileUtil;
import com.xy.shuhua.util.PathManager;
...
public class ActivityQuadrilateralCrop extends Activity implements View.OnClickListener {
    ...
    public static final String kSavePath = "save_path";

    public static void openForResult(Activity activity,String imagePath,int requestCode){
        Intent intent = new Intent(activity,ActivityQuadrilateralCrop.class);
            ...
            case R.id.nextStepView:
                new AsyncTask<Void,Void,String>(){
                    ...
                    protected String doInBackground(Void... voids) {
                        File destFile = PathManager.getCropPhotoPath();
                        FileUtil.writeImage(currentBmp,destFile.getAbsolutePath(),100);
                    ...
                    protected void onPostExecute(String path) {
                        ...
                        intent.putExtra(ActivityQuadrilateralCrop.kSavePath,path);
    ...
    private void toChangeLiangDu() {
        ...
        changeTitleBarState(false, getString(R.string.liangdu));
    ...
    private void toChangeBaoHeDu() {
        ...
        changeTitleBarState(false, getString(R.string.baohedu));
        changeBottomBarState(false);
        showImageView.setVisibility(View.INVISIBLE);
    ...
    private void toChangeDuiBiDu() {
        ...
        changeTitleBarState(false, getString(R.string.duibidu));
        changeBottomBarState(false);
        showImageView.setVisibility(View.INVISIBLE);
    ...
    private void toChangeWhiteBalance() {
        ...
        changeTitleBarState(false, getString(R.string.baipingheng));
        changeBottomBarState(false);
        showImageView.setVisibility(View.INVISIBLE);
    ...
    private void toChangeRuiDu() {
        ...
        changeTitleBarState(false, getString(R.string.ruihua));
        changeBottomBarState(false);
        showImageView.setVisibility(View.INVISIBLE);
