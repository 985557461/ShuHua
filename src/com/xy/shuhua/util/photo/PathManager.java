package com.xy.shuhua.util.photo;
...
public class PathManager {
    ...
    public static File getCropPhotoDir() {
        String path = FileUtil.getRootPath() + "/shuhua/crop/";
    ...
    public static File getCameraPhotoDir() {
        String path = FileUtil.getRootPath() + "/shuhua/photo/";
        File file = new File(path);
        if (!file.exists()) {
            file.mkdirs();
        }
    ...
    public static File getSavePicDir() {
        String path = FileUtil.getRootPath() + "/shuhua/chat/";
        File file = new File(path);
        if (!file.exists()) {
            file.mkdirs();
        }
    ...
    public static File getImageLoaderCacheDir() {
        String path = FileUtil.getRootPath() + "shuhua/imageloader/cache";
