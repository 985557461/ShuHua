...
public class PreviewActivity extends ActivityBaseNoSliding implements OnClickListener {
	...
	private void initView() {
		...
		toFilter.setVisibility((CustomApplication.android_show_filter && Build.VERSION.SDK_INT >= 8) ? View.VISIBLE
				: View.GONE);
