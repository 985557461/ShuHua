...
public class ActivityCapture extends ActivityBaseNoSliding implements
	...
	public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
		...
		public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
			...
			Log.d("xiaoyu","surfaceChanged format:" + format + ", w:" + w + ", h:" + h);
			...
			try {
				...
				Log.d("xiaoyu","Error starting camera preview: " + e.getMessage());
			}
		}
	}
